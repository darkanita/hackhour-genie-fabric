...
### 1. Open the **Catalog**
![Step 1](4fa91bcd-c573-401e-bdae-8a414e4611b2.png)  
Go to **Catalog** → **Add data → Create a catalog**.  

### 2. Create a Catalog
![Step 2](efb7952c-2f2b-4cac-b58a-4e488ae5c3f7.png)  
...
![Fabric Step 1](5c41513a-29bf-4ded-ad2f-2d9c34f096d8.png)  
- New workspace → Name: `hack_hours_fabricws`  
- Select **Fabric capacity**  
- Apply  

### 2. Create a Lakehouse
![Fabric Step 2](9aa16a30-9fa5-424d-b6e4-b3d4bd4fb8f2.png)  
- New item → **Lakehouse**  
- Name: `lh_canada_sales_v01`  

### 3. Upload Data
![Fabric Step 3](41226fb0-a5c1-45f0-9bba-8f9147e29e34.png)  
Upload: `products.csv`, `customers.csv`, `orders.csv`, `opportunities.csv`.  

### 4. Load Files into Tables
![Fabric Step 4](a876c128-2a93-4176-9f58-aea9595b9613.png)  
Right-click each CSV → **Load to Tables → New table**.  

### 5. Verify Tables
![Fabric Step 5](00bb60e9-398c-4073-93a3-513f1640af85.png)  
